...
function tutorial.createTutBoxes()
	...
	tutorialSteps[k].message = "Auf dieser Karte ist eine Gruppe von Passagieren. " ..
								...
								"zeige ich dir jetzt, wie du den Passagier mit dem nähsten Ziel auswählst."
